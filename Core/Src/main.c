...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, SPI4_RESET_Pin|SPI1_RESET_Pin|GPIO_PIN_6|GPIO_PIN_7
  ...
  /*Configure GPIO pins : SPI4_RESET_Pin SPI1_RESET_Pin PC6 PC7
                           PC8 */
  GPIO_InitStruct.Pin = SPI4_RESET_Pin|SPI1_RESET_Pin|GPIO_PIN_6|GPIO_PIN_7
                          |GPIO_PIN_8;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
